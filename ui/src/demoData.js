...
export const demoRuns = [
  {
    ...
    spans: [
      ...
      span({ span_id: 'a3', parent_id: 'a1', name: 'web_search', kind: 'mcp', started_at: t0 + 0.95, ended_at: t0 + 1.7, inputs: "'agent observability 2026'", outputs: '8 results', attributes: { 'mcp.server.name': 'brave-search', 'mcp.method.name': 'call_tool', 'mcp.transport': 'stdio' } }),
      span({ span_id: 'a3b', parent_id: 'a3', name: 'web_search', kind: 'mcp', service: 'brave-search', remote_parent_id: 'a3', started_at: t0 + 1.0, ended_at: t0 + 1.66, outputs: '8 results', attributes: { 'mcp.side': 'server' } }),
      span({ span_id: 'a3c', parent_id: 'a3b', name: 'brave_api_query', kind: 'tool', service: 'brave-search', started_at: t0 + 1.05, ended_at: t0 + 1.62, outputs: '8 hits (cache miss)' }),
